...
router.get<{}, PromotionResponse>('/', (req, res) => {
  res.json({
    'status': 'success',
    'data': {
      'promotions': [
        {
          ...
          'image_url': 'https://example.com/images/morning-brew.jpg',
        },
        {
          'id': 'COFFEE_PR_02',
          ...
          'image_url': 'https://example.com/images/latte-tuesday.jpg',
        },
        {
          'id': 'COFFEE_PR_03',
          ...
          'image_url': 'https://example.com/images/happy-hour.jpg',
        },
